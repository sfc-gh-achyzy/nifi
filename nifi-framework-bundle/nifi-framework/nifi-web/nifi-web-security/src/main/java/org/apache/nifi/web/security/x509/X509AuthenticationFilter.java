...
public class X509AuthenticationFilter extends NiFiAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(final HttpServletRequest request) {
        ...
        return new X509AuthenticationRequestToken(proxiedEntitiesChain, proxiedEntityIdpGroups, principalExtractor, certificates, request.getRemoteAddr(), request.getHeader("User-Agent"));
    }
